...
`;
  ...
  _queryChanged(e) {
    ...
    if (query == "") {
      ...
      var headwordQueryApp = this.$.headwordQueryApp; // Why are we not doing the databinding more imperatively? See comment above the iron-ajax element.
  ...
  _headwordSelectionHandler(e) {
    ...
    if (value == "") {
      ...
      var definitionQueryApp = this.$.definitionQueryApp; // Why are we not doing the databinding more imperatively? See comment above the iron-ajax element.
